...
pub const HELPER_SENTENCE: &str = "Helper packages sit on GAP";
pub const HELPER_CRATE: &str = "`crate/`";
pub const HELPER_P14: &str = "`crate-gap-285-p14-readme-tree/`";
...
pub fn names_helper_packages(src: &str) -> bool {
    src.contains(HELPER_SENTENCE) && src.contains(HELPER_CRATE) && src.contains(HELPER_P14)
}
